...
"border-radius:15;")
        ...
        self.label_3.setGeometry(QtCore.QRect(90, 50, 91, 16))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(11)
        ...
        self.pushButton.setGeometry(QtCore.QRect(210, 50, 23, 23))
        self.pushButton.setMinimumSize(QtCore.QSize(23, 23))
        self.pushButton.setMaximumSize(QtCore.QSize(23, 23))
        self.pushButton.setStyleSheet("background-image: url(C:/Users/LazimR/Documents/GitHub/Projeto_Banco/imagens/olho_fechado.png);\n"
...
"border-color:black;")
    ...
    def retranslateUi(self, TelaPrincipal):
        ...
        self.label.setText(_translate("TelaPrincipal", "Olá, User"))
        self.label_2.setText(_translate("TelaPrincipal", "Saldo:"))
        self.label_3.setText(_translate("TelaPrincipal", "123456789,9"))
