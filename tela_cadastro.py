...
class Ui_TelaCadastro(object):
        '''
        Esta classe representa a tela de cadastro do L-Bank.
        Interface construída pelo Qt Designer.

        Possui os campos de texto para nome, cpf, login e senha,
        um botão para realizar o cadastro e um botão para retornar
        à tela de login (ou tela inicial).
        '''
        ...
        def setupUi(self, TelaCadastro):
                ...
                self.Login_label.setGeometry(QtCore.QRect(70, 110, 50, 31))
        ...
        "border-color:black;")
                ...
                self.Senha_label.setGeometry(QtCore.QRect(60, 140, 398, 30))
        ...
        "border-color:black;")
                ...
                self.Cpf_label.setGeometry(QtCore.QRect(75, 70, 398, 46))
                font = QtGui.QFont()
                font.setFamily("Arial")
                font.setPointSize(11)
                ...
                self.Nome_label.setGeometry(QtCore.QRect(65, 50, 398, 31))
                font = QtGui.QFont()
                font.setFamily("Arial")
                font.setPointSize(11)
